...
// Initialize the array for counting guesses
let guessTracker = [];
...
function duplicateCheck (guess){
    let i = guessTracker.indexOf(guess);
    if (i === -1) {
        return false;
    }
    else {
...
//Check if the user's guess is correct or incorrect, and if incorrect tells them if they need to guess higher or lower
function doGuess(){
